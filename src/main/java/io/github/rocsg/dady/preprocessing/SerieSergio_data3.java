...
//        tr.writeAsDenseField("/home/rfernandez/Bureau/Test_Sergio/Data_3/Test_2_img_rec/Data/Field.tif", imgRef);
    ...
    public static void generatePairs1to2(){
        ...
        Point3d[][]tab=RegistrationUtils.getCoordinatesFromRoiSetOfCorrespondences(path,imgRef,imgMov,true);
    ...
    /**************Tests *********************************************************************************************/
     public static void testToCsv(){
        ...
        RegistrationUtils.writePointRoiToCsv(pathToRoi,pathToCsv);
    ...
    public static void testReadThenWriteRoi(){
        ...
        Point3d[]tab=RegistrationUtils.getCoordinatesFromRoiSet(path,imgRef,true);
        System.out.println("Toto3 N="+tab.length);
        PointRoi []pr=RegistrationUtils.getPointRoiTabMonoSliceFromPoint3dTab(tab,imgRef,true);
        System.out.println("Toto4");
        RegistrationUtils.saveRoiAs(pr,"/home/rfernandez/Bureau/Test_Sergio/Data_3/OtherRoiSet.zip");
