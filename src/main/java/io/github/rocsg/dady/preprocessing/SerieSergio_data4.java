...
//        evaluateMatchingBasedOnLandmarks(1);
    ...
    public static void repair(){
        ...
        Point3d[][]tab=RegistrationUtils.getCoordinatesFromRoiSetOfCorrespondences(pathToRoi,imgRef,imgMov,false);
        ...
        Roi[]tabRoi=RegistrationUtils.getPointRoiTabMonoSliceFromPoint3dTab(RegistrationUtils.point3dDoubleTabToSingleTab(newTab), imgRef, false);
        RegistrationUtils.saveRoiAs(tabRoi, pathToRoiNew);
    ...
    public static void evaluateMatchingBasedOnLandmarks(int n){
        ...
        Point3d[][]tab=RegistrationUtils.getCoordinatesFromRoiSetOfCorrespondences(pathToRoi,imgRef,imgMov,true);
        ...
        System.out.println("Before registration, stats = "+RegistrationUtils.getStatsAboutCorrespondancePoints(tab));
        ...
        System.out.println("After reg affine, stats = "+RegistrationUtils.getStatsAboutCorrespondancePoints(tab));

        //Evaluating after dense
        tab=RegistrationUtils.getCoordinatesFromRoiSetOfCorrespondences(pathToRoi,imgRef,imgMov,true);
        for(int i=0;i<Ncorr;i++){
            tab[0][i]=trDense.transformPoint(tab[0][i]);
        }
        System.out.println("After reg dense, stats = "+RegistrationUtils.getStatsAboutCorrespondancePoints(tab));
        ...
        System.out.println("After BlockMatching, stats = "+RegistrationUtils.getStatsAboutCorrespondancePoints(tab));    
...
//        tr.writeAsDenseField("/home/rfernandez/Bureau/Test_Sergio/Data_3/Test_2_img_rec/Data/Field.tif", imgRef);
    ...
    public static void annotate(int n){
        ...
        Point3d[]ptslinearized=RegistrationUtils.point3dDoubleTabToSingleTab(pts);
        RegistrationUtils.writePoint3dTabToCsv(ptslinearized, mainDir+"Csv/"+names[n]+".csv");
        Roi[]roiTab=RoiManager.getInstance().getRoisAsArray();
        RegistrationUtils.saveRoiAs(roiTab, mainDir+"Roi/"+names[n]+".zip");
